    ...
    private:  
        ...
        void callbackTurtlePose(const turtlesim::msg::Pose::SharedPtr msg){
            ...
            if (error_distance < 0.1) {  // umbral de distancia
                ...
                auto client_catch_tortuga{create_client<comienzo_interfaces::srv::CatchTortuga>("catch_tortuga")};
                ...
                auto request_catch_tortuga{std::make_shared<comienzo_interfaces::srv::CatchTortuga::Request>()};
        ...
        void callbackTortugasVivas(const comienzo_interfaces::msg::TortugaArray::SharedPtr msg){
