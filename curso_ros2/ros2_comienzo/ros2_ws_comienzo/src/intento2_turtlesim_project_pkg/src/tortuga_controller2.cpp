...
TortugaController2Node::TortugaController2Node() : Node("tortuga_controller2"){ 
    ...
    subscriber_tortugas_vivas_ = create_subscription<comienzo_interfaces::msg::TortugaArray>(
...
void TortugaController2Node::callbackTortugasVivas(const comienzo_interfaces::msg::TortugaArray::SharedPtr tortugas_vivas){
...
void TortugaController2Node::callCatchTortugaService(const std::string& nombre_tortuga){
    ...
    auto client_catch{create_client<comienzo_interfaces::srv::CatchTortuga>("catch_tortuga")};
    ...
    auto request_catch{std::make_shared<comienzo_interfaces::srv::CatchTortuga::Request>()};
