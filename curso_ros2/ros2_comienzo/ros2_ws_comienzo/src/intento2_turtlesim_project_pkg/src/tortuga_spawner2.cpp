...
TortugaSpawner2Node::TortugaSpawner2Node() : Node("tortuga_spawner2"), contador_tortugas_{0}, generador_(std::random_device{}()){
    ...
    publisher_tortugas_vivas_ = create_publisher<comienzo_interfaces::msg::TortugaArray>("tortugas_vivas", 10);
    timer_tortugas_vivas_ = create_wall_timer(std::chrono::seconds(1), std::bind(&TortugaSpawner2Node::publishTortugasVivas, this));
    service_catch_tortuga_ = create_service<comienzo_interfaces::srv::CatchTortuga>("catch_tortuga", 
...
void TortugaSpawner2Node::publishTortugasVivas(){
    auto msg{comienzo_interfaces::msg::TortugaArray()};
    msg.lista_tortugas = array_tortugas_.lista_tortugas;
    publisher_tortugas_vivas_->publish(msg); 
}

void TortugaSpawner2Node::callSpawnService(comienzo_interfaces::msg::Tortuga& tortuga){
...
comienzo_interfaces::msg::Tortuga TortugaSpawner2Node::tortugaRandomGenerator(){
    
    comienzo_interfaces::msg::Tortuga tortuga{};              
...
void TortugaSpawner2Node::callbackCatchTortuga(const comienzo_interfaces::srv::CatchTortuga::Request::SharedPtr request,
